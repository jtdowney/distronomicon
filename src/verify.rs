...
mod tests {
    ...
    async fn test_fetch_and_verify_happy_path() {
        ...
        let result =
            fetch_and_verify_checksum("test-asset.tar.gz", &checksum_url, None, &file_path).await;
    ...
    async fn test_fetch_and_verify_with_token() {
        ...
        let checksum_url = format!("{}/checksums.txt", mock_server.uri());
        let result =
            fetch_and_verify_checksum("asset.zip", &checksum_url, Some("test-token"), &file_path)
                .await;
    ...
    async fn test_fetch_and_verify_filename_not_found() {
        ...
        let checksum_url = format!("{}/checksums.txt", mock_server.uri());
        let result =
            fetch_and_verify_checksum("missing.tar.gz", &checksum_url, None, &file_path).await;
    ...
    async fn test_fetch_and_verify_hash_mismatch() {
        ...
        let checksum_url = format!("{}/checksums.txt", mock_server.uri());
        let result =
            fetch_and_verify_checksum("bad-hash.tar.gz", &checksum_url, None, &file_path).await;
    ...
    async fn test_fetch_and_verify_http_error() {
        ...
        let checksum_url = format!("{}/checksums.txt", mock_server.uri());
        let result =
            fetch_and_verify_checksum("asset.tar.gz", &checksum_url, None, &file_path).await;
